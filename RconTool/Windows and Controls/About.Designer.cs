namespace RconTool
{
    partial class About
    {
        ...
        private void InitializeComponent()
        {
			...
			this.labelBirdCommand = new System.Windows.Forms.Label();
			this.labelUpdatedBy = new System.Windows.Forms.Label();
			this.logoLinkJaronDiscord = new System.Windows.Forms.PictureBox();
			this.toolTipAboutScreen = new System.Windows.Forms.ToolTip(this.components);
			this.logoLinkJaronGitHub = new System.Windows.Forms.PictureBox();
			this.logoLinkBirdCommandDiscord = new System.Windows.Forms.PictureBox();
			this.logoLinkBirdCommandGitHub = new System.Windows.Forms.PictureBox();
			this.linkLabelProjectGitHub = new System.Windows.Forms.LinkLabel();
			this.linkLabelJoinTheDiscord = new System.Windows.Forms.LinkLabel();
			this.labelRconTool = new System.Windows.Forms.Label();
			this.labelJaron = new System.Windows.Forms.Label();
			((System.ComponentModel.ISupportInitialize)(this.pictureBox1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.logoLinkJaronDiscord)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.logoLinkJaronGitHub)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.logoLinkBirdCommandDiscord)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.logoLinkBirdCommandGitHub)).BeginInit();
			this.SuspendLayout();
			// 
			// labelVersion
			// 
			...
			this.labelBirdCommand.Text = "BIRD COMMAND";
			// 
			// labelUpdatedBy
			// 
			...
			this.toolTipAboutScreen.SetToolTip(this.logoLinkJaronDiscord, "Jaron#0898");
			// 
			// logoLinkJaronGitHub
			// 
			...
			this.toolTipAboutScreen.SetToolTip(this.logoLinkJaronGitHub, "https://github.com/jaron780/RconTool");
			// 
			...
			this.toolTipAboutScreen.SetToolTip(this.logoLinkBirdCommandDiscord, "https://discord.gg/upuphgd");
			// 
			...
			this.toolTipAboutScreen.SetToolTip(this.logoLinkBirdCommandGitHub, "https://github.com/BIRD-COMMAND");
			// 
			...
			this.toolTipAboutScreen.SetToolTip(this.linkLabelProjectGitHub, "http://www.github.com/BIRD-COMMAND");
			// 
			...
			this.toolTipAboutScreen.SetToolTip(this.linkLabelJoinTheDiscord, "http://discord.gg/upuphgd");
			// 
			// labelRconTool
			// 
			...
			this.labelJaron.TabIndex = 0;
			this.labelJaron.Text = "JARON";
			// 
			// About
			// 
			...
			this.Controls.Add(this.logoLinkBirdCommandDiscord);
			this.Controls.Add(this.logoLinkJaronGitHub);
			this.Controls.Add(this.logoLinkJaronDiscord);
			this.Controls.Add(this.labelUpdatedBy);
			this.Controls.Add(this.labelBirdCommand);
			this.Controls.Add(this.labelCreatedBy);
			this.Controls.Add(this.labelJaron);
			this.Controls.Add(this.labelRconTool);
			...
			((System.ComponentModel.ISupportInitialize)(this.logoLinkBirdCommandDiscord)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.logoLinkBirdCommandGitHub)).EndInit();
		...
		private System.Windows.Forms.Label labelBirdCommand;
		private System.Windows.Forms.Label labelUpdatedBy;
		private System.Windows.Forms.PictureBox logoLinkJaronDiscord;
		private System.Windows.Forms.ToolTip toolTipAboutScreen;
		private System.Windows.Forms.PictureBox logoLinkJaronGitHub;
		private System.Windows.Forms.PictureBox logoLinkBirdCommandDiscord;
		private System.Windows.Forms.PictureBox logoLinkBirdCommandGitHub;
		private System.Windows.Forms.Label labelRconTool;
		private System.Windows.Forms.LinkLabel linkLabelProjectGitHub;
		private System.Windows.Forms.LinkLabel linkLabelJoinTheDiscord;
		private System.Windows.Forms.Label labelJaron;
	}
}